...
//画图
  ...
  for (var i=0;i<10;i++)
  {
	...
	for (var i=0;i<10;i++)
	{
		cxt.moveTo(10+(((f[i]-f_min)/(f_max-f_min))*500),510-(fc1[i]/13000)*500);
		cxt.fillText("("+(Math.round(f[i]*10))/10+","+(Math.round(fc1[i]*10))/10+")",10+(((f[i]-f_min)/(f_max-f_min))*500),520+(20*m)-(fc1[i]/13000)*500);
		cxt.arc(10+(((f[i]-f_min)/(f_max-f_min))*500),510-(fc1[i]/13000)*500,1.5,0,Math.PI*2,true);
		cxt.closePath();
		cxt.fill();
		m=-m;
	}
	...
	cxt.fillText("切削速度/m/min",415,525);
...
lalala=lalala+"<tr><td><p><b>进给量:</b><p></td><td><p>"+document.getElementById('jjly').value+"mm/r</p></td><td></td></tr>";
lalala=lalala+"<tr><td><p><b>背吃刀量:</b><p></td><td><p>"+document.getElementById('bcdly').value+"mm</p></td><td></td></tr>";
lalala=lalala+"<tr><td><p><b>切削速度(mm/r):</b></p></td><td><b>(1)</b></p></td><td><b>(2)</b></p></td><td><b>(3)</b></p></td><td><b>(4)</b></p></td><td><b>(5)</b></p></td><td><b>(6)</b></p></td><td><b>(7)</b></p></td><td><b>(8)</b></p></td><td><b>(9)</b></p></td><td><b>(10)</b></p></td></tr> <tr><td></td>"
for (i=0;i<10;i++)
{
	lalala=lalala+"<td><p>"+f[i]+"</p></td>";
}
lalala=lalala+"</tr>";
lalala=lalala+"<tr><td><p><b>主切削力(N):</b></p></td><td><b>(1)</b></p></td><td><b>(2)</b></p></td><td><b>(3)</b></p></td><td><b>(4)</b></p></td><td><b>(5)</b></p></td><td><b>(6)</b></p></td><td><b>(7)</b></p></td><td><b>(8)</b></p></td><td><b>(9)</b></p></td><td><b>(10)</b></p></td></tr><tr><td></td>"
for (i=0;i<10;i++)
{
...
for (var i = 0; i < 10; i++) {
	...
	if(f[i]<15)
		kv[i]=(-0.01)*v+1.7;
	else if(f[i]>=15&&f[i]<25)
		kv[i]=(0.025)*v+1.175;
	else if(f[i]>=25&&f[i]<40)
		kv[i]=(-0.011)*f[i]+2.07;
	else
		kv[i]=(-0.001)*f[i]+1.65;
		kv[i]=kv[i]*0.54;
  ...
  zhishu2=Math.pow(x1,x14);


	zhishu1=Math.pow(x2,x13)/1.18;
  ...
  for(var d=0;d<10;d++)
	{
	w=w+Math.round(kv[d]*100)/100;
	w=w+"m";
  }

  w=w+Math.round(zhishu1*100)/100;
  w=w+"m";
...
function donghuabyphp(w) {
  ...
  //         var byphp100 =  xmlHttp.responseText;
	...
	dhfc[0]=(9.81)*(cfc)*(zhishu1)*(zhishu2)*(0.95)*(kkfc)*(klfc)*(knfc)*(krfc)*(kv[0])*(1-0.1*Math.random());
  dhfc[1]=(9.81)*(cfc)*(zhishu1)*(zhishu2)*(0.95)*(kkfc)*(klfc)*(knfc)*(krfc)*(kv[1])*(1-0.1*Math.random());
  dhfc[2]=(9.81)*(cfc)*(zhishu1)*(zhishu2)*(0.95)*(kkfc)*(klfc)*(knfc)*(krfc)*(kv[2])*(1-0.1*Math.random());
  dhfc[3]=(9.81)*(cfc)*(zhishu1)*(zhishu2)*(0.95)*(kkfc)*(klfc)*(knfc)*(krfc)*(kv[3])*(1-0.1*Math.random());
  dhfc[4]=(9.81)*(cfc)*(zhishu1)*(zhishu2)*(0.95)*(kkfc)*(klfc)*(knfc)*(krfc)*(kv[4])*(1-0.1*Math.random());
  dhfc[5]=(9.81)*(cfc)*(zhishu1)*(zhishu2)*(0.95)*(kkfc)*(klfc)*(knfc)*(krfc)*(kv[5])*(1-0.1*Math.random());
  dhfc[6]=(9.81)*(cfc)*(zhishu1)*(zhishu2)*(0.95)*(kkfc)*(klfc)*(knfc)*(krfc)*(kv[6])*(1-0.1*Math.random());
  dhfc[7]=(9.81)*(cfc)*(zhishu1)*(zhishu2)*(0.95)*(kkfc)*(klfc)*(knfc)*(krfc)*(kv[7])*(1-0.1*Math.random());
  dhfc[8]=(9.81)*(cfc)*(zhishu1)*(zhishu2)*(0.95)*(kkfc)*(klfc)*(knfc)*(krfc)*(kv[8])*(1-0.1*Math.random());
  dhfc[9]=(9.81)*(cfc)*(zhishu1)*(zhishu2)*(0.95)*(kkfc)*(klfc)*(knfc)*(krfc)*(kv[9])*(1-0.1*Math.random());
    ...
    force_6=Math.round(dhfc[5]*10)/10;
    force_7=Math.round(dhfc[6]*10)/10;
    force_8=Math.round(dhfc[7]*10)/10;
    force_9=Math.round(dhfc[8]*10)/10;
    force_10=Math.round(dhfc[9]*10)/10;
