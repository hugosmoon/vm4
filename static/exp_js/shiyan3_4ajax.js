...
lalala=lalala+"<b>进给量</b>:"+document.getElementById('jjly').value+"mm/r<br>";
lalala=lalala+"<b>背吃刀量</b>:"+document.getElementById('bcdly').value+"mm<br>";
lalala=lalala+"<b>切削速度d</b>(m/min):<br>"
for (i=0;i<10;i++)
{
	lalala=lalala+q[i]+"&nbsp;&nbsp;&nbsp;&nbsp;";
}
...
document.getElementById('qxlcanshukuang2_1').innerHTML = lalala;
}
